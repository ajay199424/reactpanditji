  ...
  useEffect(() => {
    const fetchLiveHero = async () => {
      try {
        ...
        console.warn(
          "CMS Server unavailable. Falling back to local hardcoded data assets.",
          error,
        );
      }
    };
        ...
        />{" "}
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3">
            ...
            >
              <FontAwesomeIcon
                icon={faWhatsapp}
                className="text-base text-[#25D366] group-hover:scale-110 transition-transform"
              />
              <span>WhatsApp</span>
            </a>
            ...
            >
              <FontAwesomeIcon
                icon={faInstagram}
                className="text-base text-[#E1306C] group-hover:scale-110 transition-transform"
              />
              <span>Instagram</span>
            </a>
          </div>
