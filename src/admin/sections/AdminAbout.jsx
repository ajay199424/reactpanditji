  ...
  return (
    <div className="min-h-screen bg-[#fffaf3] p-4 md:p-8 text-darkbrown">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Top Control Bar */}
        <div className="flex flex-col sm:flex-row justify-between items-center bg-white border border-saffron/20 p-6 rounded-[2rem] shadow-sm gap-4 sticky top-4 z-40 backdrop-blur-md bg-white/90">
          <div>
